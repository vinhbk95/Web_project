...
<body>
    ...
    <div style="text-align: center; margin: 20px 0 20px 0;"><h3>Total Order Count: ${paginationResult.totalRecords}</h3></div>
    
    <table border="1" style="width:100%; margin-bottom: 13px;">
        <tr>
            <th>Order Num</th>
            <th>Order Date</th>
            <th>Customer Name</th>
